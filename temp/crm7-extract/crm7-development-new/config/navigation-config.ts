  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/payroll/schedule-settings',
        roles: ['admin', 'manager'],
      },
      {
        title: 'Pay Items & Awards',
        href: '/payroll/pay-items',
        roles: ['admin', 'manager'],
      },
      {
        title: 'Deduction & Allowance Configuration',
        href: '/payroll/deductions-allowances',
        roles: ['admin', 'manager'],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/placements/shifts',
        roles: ['admin', 'manager', 'staff'],
      },
      {
        title: 'Roster Management',
        href: '/placements/roster',
        roles: ['admin', 'manager', 'staff'],
      },
      {
        title: 'Calendar View',
        href: '/placements/calendar',
        roles: ['admin', 'manager', 'staff'],
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: 'Contextual Help & Documentation',
            href: '/settings/help-docs',
            roles: ['admin', 'manager'],
          },
          {
            title: 'Multi-Entity / Branch Settings',
