...
async function handlePendingDeployment(deployment: z.infer<typeof DeploymentStatusSchema>) {
...
async function handleInProgressDeployment(deployment: z.infer<typeof DeploymentStatusSchema>) {
...
async function handleCompletedDeployment(deployment: z.infer<typeof DeploymentStatusSchema>) {
...
async function handleFailedDeployment(deployment: z.infer<typeof DeploymentStatusSchema>) {
