...
const Dashboard = () => {
  ...
  return (
    <>
      <h2 className="my-6 text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary">
        Dashboard
      </h2>
      ...
      <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        {isLoadingMetrics ? (
          Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-lg shadow-card-light dark:shadow-card-dark p-4"
            >
        ...
        <div className="min-w-0 p-4 bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-lg shadow-card-light dark:shadow-card-dark">
          ...
          <ul className="space-y-3 mb-4">
            <li className="flex items-center">
              ...
              <span className="text-xs ml-auto text-light-text-tertiary dark:text-dark-text-tertiary">
                2d ago
              </span>
            </li>
            <li className="flex items-center">
