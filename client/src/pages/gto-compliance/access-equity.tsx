          ...
          <CardContent className="py-6">
            <div className="flex items-center">
              ...
              <span className="text-xl font-semibold">
                {assessments ? assessments.filter(a => a.status === 'at_risk').length : '...'} at risk
              </span>
            </div>
            <div className="flex items-center mt-2">
              <XCircle className="h-6 w-6 text-red-500 mr-2" />
              <span className="text-xl font-semibold">
                {assessments ? assessments.filter(a => a.status === 'non-compliant').length : '...'} non-compliant
              </span>
            </div>
          </CardContent>
        </Card>
                      ...
                      <TableRow key={standard.id}>
                        ...
                        <TableCell>
                          {assessments?.find(a => a.standardId === standard.id) ? (
                            <Badge className={getStatusColor(assessments.find(a => a.standardId === standard.id).status)}>
                              {getStatusIcon(assessments.find(a => a.standardId === standard.id).status)}
                        ...
                        <TableCell>
                          {assessments?.find(a => a.standardId === standard.id) ? 
                            new Date(assessments.find(a => a.standardId === standard.id).assessmentDate).toLocaleDateString() :
                            'N/A'
                          }
                        </TableCell>
                        <TableCell>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground my-2">Last updated: April 15, 2024</p>
                    <div className="flex justify-between items-center mt-4">
                      <Badge variant="outline" className="rounded-full text-xs">
                        <CheckCircle className="h-3 w-3 mr-1" /> Current
                      </Badge>
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground my-2">Last updated: March 20, 2024</p>
                    <div className="flex justify-between items-center mt-4">
                      <Badge variant="outline" className="rounded-full text-xs">
                        <CheckCircle className="h-3 w-3 mr-1" /> Current
                      </Badge>
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground my-2">Last updated: February 10, 2024</p>
                    <div className="flex justify-between items-center mt-4">
                      <Badge variant="outline" className="rounded-full text-xs">
