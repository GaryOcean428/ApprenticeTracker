          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button variant="outline" className="w-full" onClick={() => handleTabChange('incidents')}>
                    View All Incidents
                  </Button>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button variant="outline" className="w-full" onClick={() => handleTabChange('risk-assessments')}>
