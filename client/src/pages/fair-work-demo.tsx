...
export default function FairWorkDemoPage() {
  ...
  const [wageBreakdown, setWageBreakdown] = useState<
  ...
  useEffect(() => {
    ...
    const totalCost =
      baseSalary + superannuation + workersComp + payrollTax + leaveLoading + adminCost;
    ...
    setWageBreakdown([
      { label: 'Base Wage', amount: baseSalary, percentage: (baseSalary / finalChargeRate) * 100 },
      {
        ...
        percentage: (superannuation / finalChargeRate) * 100,
      },
      {
        label: 'Workers Comp',
        amount: workersComp,
        percentage: (workersComp / finalChargeRate) * 100,
      },
      {
        label: 'Payroll Tax',
        amount: payrollTax,
        percentage: (payrollTax / finalChargeRate) * 100,
      },
      {
        label: 'Leave Loading',
        amount: leaveLoading,
        percentage: (leaveLoading / finalChargeRate) * 100,
      },
      {
        label: 'Admin Overhead',
        amount: adminCost,
        percentage: (adminCost / finalChargeRate) * 100,
      },
      {
        label: 'Profit Margin',
        amount: profitAmount,
        percentage: (profitAmount / finalChargeRate) * 100,
      },
    ]);
  ...
  return (
    <div className="container mx-auto py-8 px-4">
                        ...
                        <div className="bg-primary/10 p-4 rounded-lg border mt-6">
                          <div className="flex justify-between items-center">
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-lg">
                                {((chargeRate / (selectedBaseRate || 1) - 1) * 100).toFixed(1)}%
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm">
                            {(costConfig.superRate * 100).toFixed(1)}%
                          </span>
                        </div>
                        <Slider
                          id="superRate"
                          ...
                          step={0.1}
                          onValueChange={value =>
                            handleCostConfigChange('superRate', value[0] / 100)
                          }
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm">
                            {(costConfig.payrollTaxRate * 100).toFixed(2)}%
                          </span>
                        </div>
                        <Slider
                          id="payrollTaxRate"
                          ...
                          step={0.01}
                          onValueChange={value =>
                            handleCostConfigChange('payrollTaxRate', value[0] / 100)
                          }
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm">
                            {(costConfig.leaveLoading * 100).toFixed(1)}%
                          </span>
                        </div>
                        <Slider
                          id="leaveLoading"
                          ...
                          step={0.5}
                          onValueChange={value =>
                            handleCostConfigChange('leaveLoading', value[0] / 100)
                          }
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm">
                            {(costConfig.adminRate * 100).toFixed(1)}%
                          </span>
                        </div>
                        <Slider
                          id="adminRate"
                          ...
                          step={0.5}
                          onValueChange={value =>
                            handleCostConfigChange('adminRate', value[0] / 100)
                          }
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm">
                            {(costConfig.profitMargin * 100).toFixed(1)}%
                          </span>
                        </div>
                        <Slider
                          id="profitMargin"
                          ...
                          step={0.5}
                          onValueChange={value =>
                            handleCostConfigChange('profitMargin', value[0] / 100)
                          }
                        />
                      </div>
                    </div>
      ...
      <div className="p-6 border rounded-lg bg-muted/30 mt-8">
        ...
        <p className="mb-4">
          This enhanced Fair Work award interpreter allows you to calculate precise apprentice wages
        ...
        <p>
          Proper award interpretation is essential for GTOs to maintain compliance with Fair Work
          regulations and ensure apprentices are paid correctly while host employers are charged
          appropriate rates.
        </p>
      </div>
    </div>
