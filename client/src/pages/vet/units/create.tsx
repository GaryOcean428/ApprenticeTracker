    ...
    <>
      ...
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Add a new Unit of Competency to the system. Units can be linked to qualifications and
            assigned to apprentices.
          </CardDescription>
        </CardHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="e.g. Use business software applications"
                        {...field}
                        value={field.value || ''}
                      />
                    </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>The training package this unit belongs to.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 p-4 border rounded-md">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Inactive units will not be available for new qualifications or
                          enrollments.
                        </FormDescription>
                      </div>
                    </FormItem>
            ...
            <CardFooter className="flex justify-between">
              <Button type="button" variant="outline" onClick={() => navigate('/vet/units')}>
                Cancel
              </Button>
