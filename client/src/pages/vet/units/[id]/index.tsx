  ...
  if (!unit) {
    return (
      <div className="p-8">
        ...
        <p className="text-muted-foreground mb-4">The requested unit of competency could not be found.</p>
        <Button onClick={() => navigate("/vet/units")}>Return to Units List</Button>
      </div>
    );
  }
      ...
      <Tabs defaultValue="details">
        ...
        <TabsContent value="details" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Details about this unit of competency
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="usage">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Qualifications that include this unit of competency
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="assessments">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                No assessment records found for this unit.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
