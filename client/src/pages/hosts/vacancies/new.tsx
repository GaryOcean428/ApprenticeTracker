                  ...
                  <div className="space-y-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            Host Employer <span className="text-destructive">*</span>
                          </FormLabel>
                          <Select
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                              ...
                              <div className="space-y-1 leading-none">
                                <FormLabel>Registered GTO Position</FormLabel>
                                <FormDescription>
                              ...
                              <SelectContent>
                                {classifications?.map(classification => (
                                  ...
                                  >
                                    ...
                                    {classification.minHourlyRate.toFixed(2)}/hr)
                                  </SelectItem>
                                ))}
                              </SelectContent>
                            </Select>
