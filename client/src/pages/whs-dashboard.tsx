...
import { AlertTriangle, ShieldAlert, Clipboard, FileText } from 'lucide-react';
        ...
        <TabsContent value="overview">
          ...
          {statsLoading ? null : statistics?.urgentNotifications?.length > 0 ? (
            <Alert variant="destructive" className="mb-6">
              ...
              <AlertDescription>
                There are {statistics.urgentNotifications.length} urgent safety notifications that
                require attention.
              </AlertDescription>
            </Alert>
          ) : null}
                ...
                {risksLoading ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {(!riskAssessments?.assessments ||
                      riskAssessments.assessments.length === 0) && (
                      <p className="text-center text-muted-foreground py-4">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            {loading ? (
              ...
              >
                {change > 0 ? `+${change}%` : change < 0 ? `${change}%` : 'No change'} from last
                month
              </p>
            ) : null}
          </div>
