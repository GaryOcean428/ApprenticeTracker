      ...
      <CardContent>
          ...
          <div className="space-y-4">
            {alerts?.map((alert) => (
              ...
              >
                ...
                <div className="rounded-full px-2 py-1 text-xs border">
                  {alert.type}
                </div>
              </div>
            ))}
        ...
        <div className="mt-6 space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Manage and store compliance-related documents with version control.</p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold">Automated Monitoring</h3>
            <p className="text-sm text-muted-foreground">Continuously monitor compliance requirements and statuses.</p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold">Audit Trail</h3>
            <p className="text-sm text-muted-foreground">Maintain a detailed log of compliance-related activities and changes.</p>
          </div>
        </div>
      </CardContent>
    </Card>
