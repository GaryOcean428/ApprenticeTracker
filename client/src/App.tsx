  ...
  return (
    <MainLayout>
      <Switch>
        ...
        <Route
          path="/apprentices/recruitment"
          component={() => {
            const ApprenticeRecruitment = lazy(
              () => import('./pages/apprentices/recruitment/index')
            );
            return (
              <Suspense
                fallback={
        ...
        <Route
          path="/apprentices/recruitment/selections"
          component={() => {
            const ApprenticeSelections = lazy(
              () => import('./pages/apprentices/recruitment/selections')
            );
            return (
              <Suspense
                fallback={
        ...
        <Route
          path="/apprentices/recruitment/onboarding"
          component={() => {
            const ApprenticeOnboarding = lazy(
              () => import('./pages/apprentices/recruitment/onboarding')
            );
            return (
              <Suspense
                fallback={
        ...
        <ProtectedRoute
          path="/field-officers/case-notes"
          component={() => {
        ...
        />
        <ProtectedRoute
          path="/field-officers/competency"
          component={() => {
        ...
        <ProtectedRoute
          path="/gto-compliance/access-equity"
          component={() => {
        ...
        />
        <ProtectedRoute
          path="/gto-compliance/records-management"
          component={() => {
            const RecordsManagement = lazy(
              () => import('./pages/gto-compliance/records-management')
            );
            return (
              <Suspense fallback={<div>Loading...</div>}>
                <RecordsManagement />
        ...
        />
        <ProtectedRoute
          path="/gto-compliance/risk-management"
          component={() => {
        ...
        />
        <Route
          path="/vet/qualifications/import"
          component={() => {
        ...
        />
        <Route
          path="/vet/qualifications/:id/edit"
          component={() => {
        ...
        />
        <Route
          path="/vet/qualifications/:id/structure"
          component={() => {
            const QualificationStructure = lazy(
              () => import('./pages/vet/qualifications/[id]/structure')
            );
            return (
              <Suspense
                fallback={
        ...
        />
        <Route
          path="/vet/training-packages/:id"
          component={() => {
            const TrainingPackageDetail = lazy(
              () => import('./pages/vet/training-packages/[id]/index')
            );
            return (
              <Suspense
                fallback={
        ...
        <Route
          path="/vet/training-packages/import"
          component={() => {
            return (
              <div className="p-8">
        ...
        <ProtectedRoute
          path="/progress-reviews/reviews/create"
          component={() => {
            return (
              <div className="p-8">
        ...
        <ProtectedRoute
          path="/external-employees/apprentices"
          component={() => {
            const ApprenticesSection = lazy(
              () => import('./pages/external-employees/apprentices/index')
            );
            return (
              <Suspense
                fallback={
        ...
        <ProtectedRoute
          path="/external-employees/workers"
          component={() => {
