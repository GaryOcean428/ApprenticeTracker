...
export async function seedEnrichmentData() {
  ...
  try {
    ...
    const [programCount] = await db.select({ count: sql`count(*)` }).from(enrichmentPrograms);
    ...
    const programs = [
      {
        ...
        description:
          'A comprehensive program focused on developing leadership skills for senior apprentices preparing for supervisory roles. Includes modules on communication, conflict resolution, and team management.',
      ...
      },
      {
        ...
        description:
          'Essential safety training tailored for construction apprentices. Covers workplace hazards, proper equipment usage, and emergency procedures.',
        category: 'safety',
        status: 'upcoming',
      ...
      },
      {
        ...
        description:
          'Intensive training on essential digital tools and software used in modern workplaces. Includes sessions on office productivity software, communication tools, and basic coding concepts.',
        category: 'technical',
        status: 'active',
      ...
      },
      {
        ...
        description:
          'A focused program on developing effective verbal and written communication skills for the workplace. Includes presentation techniques, email etiquette, and client interaction strategies.',
      ...
      },
      {
        ...
        description:
          'Essential financial education for young professionals. Covers budgeting, saving strategies, tax basics, and planning for future career advancement.',
    ...
    if (apprentices.length > 0) {
      ...
      const safetyWorkshops = [
        {
          ...
          description:
            'Learn to identify common workplace hazards in construction environments and implement proper risk mitigation strategies.',
        ...
        },
        {
          ...
          description:
            'Comprehensive overview of PPE requirements, proper usage, maintenance, and when different types of protection are required by law.',
        ...
        },
        {
          ...
          description:
            'Training on proper responses to workplace emergencies including injuries, fires, structural issues, and evacuation protocols.',
        ...
        },
        {
          ...
          description:
            'Final assessment for the Safety First Workshop Series. Successful completion results in a recognized safety certification.',
      ...
      const insertedWorkshops = await db
        .insert(enrichmentWorkshops)
        .values(safetyWorkshops)
        .returning();
      ...
      const insertedRegistrations = await db
        .insert(workshopAttendees)
        .values(workshopRegistrations)
        .returning();
