...
export class AuthService {
  ...
  private static async createDevFallbackLogin(
    email: string,
    req?: Request
  ): Promise<
    ServiceResponse<{
  ...
  > {
    try {
      const { username, email, password, firstName, lastName, role, roleId, organizationId } =
        userData;
  ...
  private static async createUserVerificationResponse(
    user: UserData,
    req?: Request
  ): Promise<
    ServiceResponse<{
