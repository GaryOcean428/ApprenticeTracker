...
router.delete('/:clientId/contacts/:contactId', clientsAuthorized, async (req: Request, res: Response) => {
  try {
...
router.put('/:clientId/contacts/:contactId/primary', clientsAuthorized, async (req: Request, res: Response) => {
  try {
    const clientId = parseInt(req.params.clientId);
    const contactId = parseInt(req.params.contactId);
