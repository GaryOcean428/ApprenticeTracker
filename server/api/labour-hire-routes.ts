...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire workers", { error: error instanceof Error ? error.message : String(error) });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire worker", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error creating labour hire worker", { error: error instanceof Error ? error.message : String(error) });
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error updating labour hire worker", { error: error instanceof Error ? error.message : String(error) });
...
router.delete(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error deleting labour hire worker", { error: error instanceof Error ? error.message : String(error) });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire placements", { error: error instanceof Error ? error.message : String(error) });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire placement", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error creating labour hire placement", { error: error instanceof Error ? error.message : String(error) });
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error updating labour hire placement", { error: error instanceof Error ? error.message : String(error) });
...
router.delete(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error deleting labour hire placement", { error: error instanceof Error ? error.message : String(error) });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire timesheets", { error: error instanceof Error ? error.message : String(error) });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire timesheet", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error creating labour hire timesheet", { error: error instanceof Error ? error.message : String(error) });
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error updating labour hire timesheet", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error submitting labour hire timesheet", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error approving labour hire timesheet", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error rejecting labour hire timesheet", { error: error instanceof Error ? error.message : String(error) });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error fetching labour hire worker documents", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error creating labour hire worker document", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error verifying labour hire worker document", { error: error instanceof Error ? error.message : String(error) });
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      logger.error("Error rejecting labour hire worker document", { error: error instanceof Error ? error.message : String(error) });
