  ...
  async (req: express.Request, res: express.Response) => {
    try {
      ...
      if (classificationLevel)
        options.classificationLevel = parseInt(classificationLevel as string);
      if (classificationFixedId)
        options.classificationFixedId = parseInt(classificationFixedId as string);
...
router.get(
  ...
  [
    ...
    query('hasCompletedYear12')
      .optional()
      .isBoolean()
      .withMessage('hasCompletedYear12 must be a boolean'),
  ],
  async (req: express.Request, res: express.Response) => {
...
router.get(
  ...
  async (req: express.Request, res: express.Response) => {
    ...
    try {
      ...
      const rate = await awardRateCalculator.getClassificationPayRate(award, classification);
