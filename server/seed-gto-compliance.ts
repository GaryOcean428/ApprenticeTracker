    ...
    const standards: InsertGtoComplianceStandard[] = [
      {
        ...
        standardDescription: "The GTO recruits, employs and inducts apprentices and trainees in accordance with government requirements, funding arrangements, modern awards and legislative requirements.",
      ...
      },
      {
        ...
        standardDescription: "The GTO provides services that meet the individual needs of apprentices and trainees to facilitate the continuity of the training contract to completion and the quality and breadth of the training experience.",
        category: "Monitoring",
        requiredEvidence: [
          "Training plans",
      ...
      },
      {
        ...
        standardDescription: "The GTO develops and monitors host employer arrangements to ensure that host employers provide a safe and supportive environment for apprentices and trainees.",
        category: "Monitoring",
        requiredEvidence: [
      ...
      },
      {
        ...
        standardDescription: "The GTO complies with Commonwealth, State and Territory legislation, regulatory requirements, and initiatives relevant to GTOs, apprentices, trainees and host employers.",
        category: "Governance",
        requiredEvidence: [
          "Compliance register",
          "Policy documents",
      ...
      },
      {
        ...
        standardDescription: "The GTO is well governed and administers its operations soundly to provide quality services to apprentices, trainees and host employers.",
        category: "Governance",
        requiredEvidence: [
      ...
      },
      {
        ...
        standardDescription: "The GTO monitors and continually improves its performance using good practices for the management and operations of a GTO.",
        category: "Governance",
        requiredEvidence: [
      ...
      },
      {
        ...
        standardDescription: "The GTO works with the nominated RTO to provide a coordinated approach to the development and delivery of training that meets the apprentice's or trainee's needs.",
        category: "Monitoring",
        requiredEvidence: [
          "RTO agreements",
      ...
      },
      {
        ...
        standardDescription: "The GTO has established processes to effectively manage complaints and appeals.",
        category: "Governance",
        requiredEvidence: [
          "Complaints policy",
          "Appeals policy",
      ...
      },
      {
        ...
        standardDescription: "The GTO implements the principles of access and equity and maximizes outcomes for apprentices and trainees.",
        category: "Governance",
        requiredEvidence: [
      ...
      },
      {
        ...
        standardDescription: "The GTO provides clear, accurate and truthful information to prospective apprentices, trainees and host employers.",
        category: "Recruitment",
        requiredEvidence: [
          "Marketing materials",
